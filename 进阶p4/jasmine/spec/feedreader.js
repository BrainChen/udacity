...
$(function() {
    ...
    */
        ...
        */
        ...
        function checkEquality(index) {
        	allFeeds.forEach(function (element) {
        		expect(element.index).toBeDefined();
        		expect(element.index).not.toBeNull();
        		expect(element.index).not.tobe('');
        	});
        };
    ...
    describe('The menu', function() {
        var spy, one, two;
        //do some test to check the result
        beforeEach(function(){
            spy = function() {
                $('.menu-icon-link').click();
            };
            spy();
            one = document.getElementsByClassName('menu-hidden').length;
            spy();
            two = document.getElementsByClassName('menu-hidden').length;
        });
        /* TODO:
         * 写一个测试用例保证菜单元素默认是隐藏的。你需要分析 html 和 css
         * 来搞清楚我们是怎么实现隐藏/展示菜单元素的。
         */
         it('defult hidden menu', function() {
          ...
          * 再次点击的时候是否隐藏。
          */
          it('click to transform', function() {
    ...
    describe("Initial Entries", function() {
        ...
        it('loading successfully', function(done) {
    ...
    describe('New Feed Selection', function() {
        ...
        it('change successfully', function() {
